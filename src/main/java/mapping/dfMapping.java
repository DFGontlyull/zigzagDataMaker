...
public class dfMapping extends AbstractMapping<stringPlate> {
    private String schema = "";
    private Connection connection;

    public dfMapping(String table, Connection connection) {
        super("zigzag", table);
        this.connection = connection;
        this.mapText("term", stringPlate::getContent);
        this.mapInteger("df", stringPlate::getDocNumber);
    }
